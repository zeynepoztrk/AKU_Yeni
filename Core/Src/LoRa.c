...
/* ----------------------------------------------------------------------------- *\
		...
		description : this module is added afterwards by Kagan Onem. It's main idea is to set up
			desired LoRa configuration without interrupting the functionality of the library.

		arguments   :
			LoRa* LoRa --> LoRa object handler

		returns     : Desired LoRa configuration
\* ----------------------------------------------------------------------------- */
